* TODO fastCGI and Clojure over JNA?
  [[https://github.com/Chouser/clojure-jna][clojure-jna]] and Chicken's [[https://code.call-cc.org/svn/chicken-eggs/release/4/fastcgi/trunk/fastcgi.scm][fastcgi]] implementation.
  ...
  #+BEGIN_SRC clojure :tangle compile-to-regex.clj :shebang #!/usr/bin/env clj
    ...
    (let [;; Terminals
      ...
      (let [template '(restaurant-or-cuisine in-locality? with-attributes?)
        ...
        ;; doesn't it? Yes.
        (debug (generate-templates generators non-terminals template))))
