* TODO Get something working.
  ...
  #+BEGIN_SRC java :tangle mixer.bsh :shebang #!/usr/bin/env bsh
    ...
    // FORMAT = new AudioFormat((float) 8000.0, 8, 1, true, false);
    print(FORMAT.getChannels());
    print(FORMAT.getEncoding());
    print(FORMAT.getFrameRate());
    print(FORMAT.getFrameSize());
    print(FORMAT.getSampleRate());
    print(FORMAT.getSampleSizeInBits());
    print(FORMAT.isBigEndian());
    ...
    print(new FlacFormatConversionProvider().getTargetEncodings(FORMAT));
    flacStream = new FlacFormatConversionProvider()
        .getAudioInputStream(FlacEncoding.FLAC, inputStream);
    // AudioSystem.write(inputStream,
    //                   AudioFileFormat.Type.WAVE,
    //                   new File("harro.wav"));
    AudioSystem.write(flacStream,
                      FlacFileFormatType.FLAC,
                      new File("harro.flac"));
